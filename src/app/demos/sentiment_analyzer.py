...
The agent can:
  ...
  • Identify key phrases and their sentiment
  • Rate confidence levels

This showcases how tools can augment an LLM with structured
...
# ─── Simple lexicon-based analysis (demo purposes) ───────────────
...
class SentimentDemo:
    """Sentiment analyzer demo runner."""
...
register_demo(DemoInfo(
    ...
    description="Text analysis agent that detects sentiment, emotions, key phrases, and word frequency. Uses lexicon-based tools to provide structured analysis of any text.",
    icon="💬",
